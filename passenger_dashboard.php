...
.btn-book:hover {
  ...
  .sidebar-power a {
    padding: 14px 28px;        /* same as other sidebar links */
    text-decoration: none;
    font-size: 18px;
    color: #ddd;
    display: block;
...
.sidebar-power a:hover {
    background: #2e7d32;       /* same hover color */
    color: #fff;
    padding-left: 35px;        /* sliding effect */
}
